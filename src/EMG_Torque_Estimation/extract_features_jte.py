...
#* This script preprocesses EMG and Qualisys data, extracts relevant temporal, spectral and time-freq features and saves them into a numpy file as a dict. In addition, it also saves the scaler info for rescaling the output
...
if cfg.preprocess_param.is_save_features:
    ...
    dump(
        {"Y_scaler_dict": Y_scaler_dict,
         "Y_scaler_info": Y_scaler_info}, 
        save_path / (filename_pkl+".pkl"))
