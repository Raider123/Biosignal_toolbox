...
#* This script preprocesses EMG and Qualisys data (all datasets together), extracts relevant temporal, spectral and time-freq features and saves them into a numpy file as a dict. In addition, it also saves the scaler info for rescaling the output
