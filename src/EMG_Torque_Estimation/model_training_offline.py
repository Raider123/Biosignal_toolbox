...
from biosignal_toolbox.utils import loadConfig, convertDictToNamespace, checkCreateDir, createReadme, plotResults
...
for typ_idx in range(len(cfg.data_param.mov_type)):
    for wgt_idx in range(len(cfg.data_param.weights)):
        for set_idx in range(len(cfg.data_param.set_num)):
            ...
            if Path(cfg.filepath.project_path+cfg.filepath.data_path+cfg.filepath.emg_path+cfg.data_param.weights[wgt_idx]+'_'+cfg.data_param.mov_type[typ_idx]+'_'+cfg.data_param.set_num[set_idx]+'.txt').is_file():

                #! Loading and epoching for training   
                EMG_Data = EMGData(format="ANTmini", filenames=[cfg.filepath.emg_path+cfg.data_param.weights[wgt_idx]+'_'+cfg.data_param.mov_type[typ_idx]+'_'+cfg.data_param.set_num[set_idx]+'.txt'], data_path=cfg.filepath.project_path+cfg.filepath.data_path, f_samp=cfg.preprocess_param.f_samp, channel_names=cfg.preprocess_param.channel_names_emg)
                ...
                Quali_Data_Elbow = EEGData(format="NumpyQualisys", 
                                           ...
                                           data_path=cfg.filepath.project_path+cfg.filepath.data_path, 
...
MLP_model_e.trainModel(save_trained_model=cfg.model_param.is_save_model, 
                       model_filename=cfg.filepath.project_path+cfg.filepath.data_path+"zdemo_ml_models/"+cfg.data_param.subject_code+"_"+scenario_name+result_file_name+"_AAN_model_elbow_mav", 
...
MLP_model_f.trainModel(save_trained_model=cfg.model_param.is_save_model, 
                       model_filename=cfg.filepath.project_path+cfg.filepath.data_path+"zdemo_ml_models/"+cfg.data_param.subject_code+"_"+scenario_name+result_file_name+"_AAN_model_front_mav", 
                       train_epochs=cfg.model_param.n_epochs, 
                       batch_size=cfg.model_param.batch_size, 
                       class_weights=None, 
                       x_train=x_train_combined, 
...
MLP_model_s.trainModel(save_trained_model=cfg.model_param.is_save_model, 
                       model_filename=cfg.filepath.project_path+cfg.filepath.data_path+"zdemo_ml_models/"+cfg.data_param.subject_code+"_"+scenario_name+result_file_name+"_AAN_model_side_mav", 
                       train_epochs=cfg.model_param.n_epochs, 
                       batch_size=cfg.model_param.batch_size, 
                       class_weights=None, 
                       x_train=x_train_combined, 
