...
# Paths of the datasets that are available
...
# Results folder path
base_folder_path = "C:/Users/Chrissy/Desktop/Results/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(D) + "," + str(F2) + "_" + date + "_" + time + "_ShallowConvNet" + "/"
...
for dataset_key in datasets:
    ...
    for idx, combination in enumerate(combinations_list):
        ...
        model = ShallowConvNet(2, Chans=chans, Samples=samples, dropoutRate=0.5)
        ...
        checkpointer = ModelCheckpoint(
            filepath="/tmp/checkpoint/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(
                D) + "," + str(F2) + "/" + dataset_name + "_SCN" + '.h5', verbose=1,
            save_best_only=True)
        ...
        model.load_weights("/tmp/checkpoint/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(D) + "," + str(F2) + "/" + dataset_name + "_SCN" + '.h5')
...
results_df.to_csv(os.path.join(base_folder_path, "results_SCN.csv"), index=False, sep=';')
