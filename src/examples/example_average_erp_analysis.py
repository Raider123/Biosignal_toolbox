...
data.rereferencingEpoching(marker_number, error_number, channel_list, apply_filter=apply_filter, f_highpass = f_highpass, f_lowpass= f_lowpass, inverse_keep_channel = inverse_keep_channel, event_id_used = event_id_used, t1 =epoching_time_before_onset, t2= epoching_time_after_onset)
