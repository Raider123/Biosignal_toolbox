...
# Results folder path
base_folder_path = "C:/Users/Chrissy/Desktop/Results/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(D) + "," + str(F2) + "_" + date + "_" + time + "_EEGNet" + "/"
    ...
    for idx, combination in enumerate(combinations_list):
        ...
        checkpointer = ModelCheckpoint(
            filepath="/tmp/checkpoint/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(
                D) + "," + str(F2) + "/" + dataset_name + "_EEGN" + '.h5', verbose=1,
            save_best_only=True)
        ...
        model.load_weights("/tmp/checkpoint/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(D) + "," + str(F2) + "/" + dataset_name + "_EEGN" + '.h5')
        ...
        avg_train_loss[dataset_name].append(train_loss)  # validation loss of the last epoch
        ...
        average_bal_acc_list.append(test_bal_acc)  # Add the average balanced accuracy to a list
        plt.figure()
...
results_df.to_csv(os.path.join(base_folder_path, "results_EEGN.csv"), index=False, sep=';')
