...
base_folder_path = "C:/Users/Chrissy/Desktop/Results/" + str(dropoutRate) + "," + str(kernLength) + "," + str(
    F1) + "," + str(D) + "," + str(F2) + "_" + date + "_" + time + "_EEGN_dp" + "/"
...
for i in range(n_sets):
    ...
    checkpointer = ModelCheckpoint(
        filepath="/tmp/checkpoint/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(
            D) + "," + str(F2) + "/" + dataset_name + "_EEGN_dp" + '.h5', verbose=1,
        save_best_only=True)
    ...
    model.load_weights("/tmp/checkpoint/" + str(dropoutRate) + "," + str(kernLength) + "," + str(F1) + "," + str(D) + "," + str(F2) + "/" + dataset_name + "_EEGN_dp" + '.h5')
...
results_df.to_csv(os.path.join(base_folder_path, "results_EEGNdp.csv"), index=False, sep=';')
