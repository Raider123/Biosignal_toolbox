...
def MLPProcessingOnline(EEG_MLP, EEG_freq_MLP, window_labels, feature_indices_windows, sos_MLP): 
...
def EEGNetProcessingOnline(EEG_EEGNet, window_labels, num_classes, sos_EEGNet): 
