...
result_file_name = "fcn_network_results_postprocessing_range_test_1"
...
n_epochs = 20 #20 training epochs (max since early stopping is used)
...
evaluation_time_per_window = 700 # the time in ms used at the end of each window for the prediction (in respect to 4 sampels at 20 Hz downsampling as features!)
...
for subject in subject_names:
    for iteration in interations:
        ...
        trial_prediction_test = trial_prediction_test[:,:,0] # just because of shape issues 
        ...
        wind_arr_predictions, num_of_windows, wind_names = eeg_lib.windowEEGEpochs(predicted_labels_test, f_samp_eeg, window_size, window_step) # currently only with channel dim False is supported!
        ...
        wind_arr_scores, num_of_windows, wind_names = eeg_lib.windowEEGEpochs(trial_prediction_test, f_samp_eeg, window_size, window_step) # currently only with channel dim False is supported!
        ...
        print("")
        print("Metrics of trials (with postprocessing/ long short scores on windows): ")
        ...
        # *********************************************************************************
        # ********************* Online movement onset and metric calculation  *************
        # *********************************************************************************
...
# #window postprocessing: long and short criteriums 
# window_prediction_scores = eeg_lib.onlineWindowPredictionPostprocessing(wind_arr_scores, short_tresh, mid_tresh, long_tresh, short_sampels, long_sampels, mid_sampels)
...
# Second approach 
# num_pos_windows = 1
# window_onsets = eeg_lib.calcEEGWindowOnset(window_predictions, num_pos_windows)

# num_class_instances = 1
# ba_trial, tnr_trial, tpr_trial = eeg_lib.calcTrialMetricWindows(window_onsets, searching_bounds, num_class_instances)


# print("")
# print("Metrics of trials window labels count: ")
# print("TNR: ",np.round(tnr_trial, 3))
# print("TPR: ",np.round(tpr_trial, 3))
# print("BA: ", np.round(ba_trial, 3))
# print("")
...
# n_moving = 300
# smoothed_prediction_scores = eeg_lib.calcMovingAveragePredictionScores(predicted_labels_test*trial_prediction_test, n_moving)
# decision_bound = 0.5
# num_class_instances = 1
# pos_class_start_time = -1000
# ba_smooth, tnr_smooth, tpr_smooth  = eeg_lib.calcTrialMetric(smoothed_prediction_scores, pos_class_start_time, f_samp_eeg, decision_bound, num_class_instances)


# print("")
# print("Metrics of trials window labels count: ")
# print("TNR: ",np.round(tnr_smooth, 3))
# print("TPR: ",np.round(tpr_smooth, 3))
# print("BA: ", np.round(ba_smooth, 3))
# print("")
